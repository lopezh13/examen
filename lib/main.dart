...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      title: 'Flutter Demo',
      theme: ThemeData(
        colorScheme: ColorScheme.fromSeed(seedColor: Color.fromARGB(255, 137, 104, 237)),
        useMaterial3: true,
      ),
      home: const MyHomePage(title: 'Formas de pasar parametros de una pantalla a otra'),
    );
  }
}
